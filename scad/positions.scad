...
gear_side_bearing_y = bearing_height/2-m3_socket_head_height+2;
...
// motor position
motor_x = main_body_x-main_body_width/2-motor_side/2;
...
gear_dist = sqrt(pow(motor_z,2)+pow(motor_x,2));
echo("GEAR DIST: ", gear_dist);
